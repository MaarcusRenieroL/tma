...
import { HlmSheetComponent, HlmSheetContentComponent, HlmSheetHeaderComponent } from "@spartan-ng/ui-sheet-helm";
import {
...
@NgModule({
    ...
    imports: [ CommonModule, NgIconsModule.withIcons({
        heroUser,
        bootstrapEye,
        bootstrapPen,
        bootstrapTrash
    }), BrnSheetContentDirective, BrnSheetTriggerDirective, hlmBtnDirective, HlmSheetComponent, HlmSheetContentComponent, HlmSheetHeaderComponent, HlmCardDirective, HlmCardHeaderDirective, HlmCardContentDirective, HlmCardTitleDirective, HlmCardDescriptionDirective ],
