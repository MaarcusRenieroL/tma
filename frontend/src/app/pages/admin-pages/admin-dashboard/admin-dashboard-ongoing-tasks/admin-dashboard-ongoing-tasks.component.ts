...
@Component({
	selector: 'admin-dashboard-ongoing-tasks',
	templateUrl: './admin-dashboard-ongoing-tasks.component.html',
	styleUrl: './admin-dashboard-ongoing-tasks.css'
})
export class AdminDashboardOngoingTasksComponent {
	tasks = [ {
		title: 'Task 1',
