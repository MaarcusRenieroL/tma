...
@Component({
  selector: 'admin-project-files-tab',
  templateUrl: './admin-project-files-tab.component.html',
  styleUrl: './admin-project-files-tab.component.css'
})
export class AdminProjectFilesTabComponent implements OnInit {
  files: File[] = [];
  filteredFiles: File[] = [];
