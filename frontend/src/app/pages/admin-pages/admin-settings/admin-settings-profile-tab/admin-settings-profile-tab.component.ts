...
@Component({
	selector: 'admin-settings-profile-tab',
	templateUrl: './admin-settings-profile-tab.component.html',
	styleUrl: './admin-settings-profile-tab.component.css'
})
export class AdminSettingsProfileTabComponent {
	file: File | null = null;
