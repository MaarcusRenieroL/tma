...
@Component({
  selector: "developer-dashboard-ongoing-tasks",
  templateUrl: "./developer-dashboard-ongoing-tasks.component.html",
})
export class DeveloperDashboardOngoingTasksComponent {
  tasks = [
    {
      title: "Task 1",
