	...
	applyFilters() {
		...
		if (this.searchQuery) {
			this.filteredTeams = this.filteredTeams.filter((team) =>
				...
				team.teamDescription.toLowerCase().includes(this.searchQuery.toLowerCase())
			);
		}
		...
		if (this.selectedSortBy) {
			switch (this.selectedSortBy) {
				case 'name_asc':
					this.filteredTeams.sort((a, b) => a.teamName.localeCompare(b.teamName));
					break;
				case 'name_desc':
					this.filteredTeams.sort((a, b) => b.teamName.localeCompare(a.teamName));
					break;
				case 'created_at_asc':
