...
@Component({
  selector: 'project-lead-dashboard-ongoing-tasks',
  templateUrl: './project-lead-dashboard-ongoing-tasks.component.html',
  styleUrl: './project-lead-dashboard-ongoing-tasks.component.css'
})
export class ProjectLeadDashboardOngoingTasksComponent {
  tasks = [
    {
      title: "Task 1",
