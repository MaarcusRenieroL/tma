...
@Component({
  selector: 'project-lead-settings-profile-tab',
  templateUrl: './project-lead-settings-profile-tab.component.html',
})
export class ProjectLeadSettingsProfileTabComponent {
  file: File | null = null;
