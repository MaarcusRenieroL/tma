...
@Component({
  selector: 'team-lead-dashboard-ongoing-tasks',
  templateUrl: './team-lead-dashboard-ongoing-tasks.component.html',
  styleUrl: './team-lead-dashboard-ongoing-tasks.component.css'
})
export class TeamLeadDashboardOngoingTasksComponent {
  tasks = [
    {
      title: "Task 1",
