...
import { Notification } from "../../../models/notificition";

@Component({
  selector: 'team-lead-notifications',
  templateUrl: './team-lead-notifications.component.html',
  styleUrl: './team-lead-notifications.component.css'
})
export class TeamLeadNotificationsComponent {
