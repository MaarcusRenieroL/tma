...
public class TeamServiceImplementation implements TeamService {
  ...
  @Override
  public ResponseEntity<StandardResponse<Team>> createTeam(Team team, UUID userId, HttpServletRequest request) {
    ...
    if (team == null || userId == null) {
      return ResponseUtil.buildErrorMessage(
        ...
        "Team and userId cannot be null",
        request,
        LocalDateTime.now()
      );
    }
  ...
  @Override
  public ResponseEntity<StandardResponse<Team>> getTeamById(UUID teamId, HttpServletRequest request) {
    if (teamId == null) {
      return ResponseUtil.buildErrorMessage(
        HttpStatus.BAD_REQUEST,
  ...
  @Override
  public ResponseEntity<StandardResponse<Team>> updateTeam(UUID teamId, Team team, HttpServletRequest request) {
  ...
  @Override
  public ResponseEntity<StandardResponse<Team>> deleteTeam(UUID teamId, UUID userId, HttpServletRequest request) {
  ...
  @Override
  public ResponseEntity<StandardResponse<List<User>>> getAllUsersByIds(List<UUID> userIds,HttpServletRequest request) {
  ...
  @Override
  public ResponseEntity<StandardResponse<Set<UUID>>>getUserByTeamId(UUID teamId,HttpServletRequest request) {
    if(teamId==null){
      return ResponseUtil.buildErrorMessage(
        HttpStatus.BAD_REQUEST,
        "Team ID cannot be null",
  ...
  public ResponseEntity<StandardResponse<Object>> assignProjectToTeam(AssignProjectToTeamRequest assignProjectToTeamRequest,HttpServletRequest request) {
    ...
    try {
      ...
      Team existingTeam = teamRepository.findById(assignProjectToTeamRequest.getTeamId())
